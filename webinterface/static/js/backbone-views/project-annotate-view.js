...
ThumbanailPaginationView = Backbone.View.extend({
    ...
    loadPage: function(page) {
        ...
        orchestratorView.thumbnailStripView.loadThumbnails(offset);
        orchestratorView.thumbnailStripView.render();
...
var AnnotationSelectionView = Backbone.View.extend({
    ...
    render: function() {
        ...
        if(this.options.broadScaleProject) { // BS project
            ...
            // append some extra content
            $('<form class="navbar-form"> \
                <button type="button" class="btn btn-info navbar-btn" data-toggle="modal" data-target="#StatsModal">Charts</button> \
    ...
    renderAnnotationPanel: function() {
        ...
        for(var i=0; i<codeList.length; i++) {
            ...
            //make readable
            var codeName = a.title = codeList[i].fields.code_name.split(":");
            codeName = codeName[codeName.length-1];

            a.title = codeName;
            a.href = "#";

            var caab = codeList[i].fields.caab_code;
            var text = codeList[i].fields.cpc_code;
            ...
            a.setAttribute("title", codeName);

            // Append a text node to the cell
            newCell.appendChild(a);
            newCell.bgColor = "yellow";

            if(caab.indexOf("803") == 0) //Macroalgae
                newCell.bgColor = "#f70e17";
            if(caab.indexOf("19") == 0) //Brachiopods
                newCell.bgColor = "#696914";
            if(caab.indexOf("33") == 0) //Sea Spiders
                newCell.bgColor = "#808080";
            if(caab.indexOf("63") == 0) //Seagrasses
                newCell.bgColor = "#1a4b63";
            if(caab.indexOf("37") == 0) //Fishes
                newCell.bgColor = "#fcca9c";
            if(caab.indexOf("81") == 0) //Bioturbation
                newCell.bgColor = "#6acccc";
            if(caab.indexOf("35") == 0) //Ascidians
                newCell.bgColor = "#999";
            if(caab.indexOf("11") == 0) //Cnidaria
                newCell.bgColor = "#fa7d1e";
            if(caab.indexOf("27") == 0 || caab.indexOf("28") == 0) //Crustacea
                newCell.bgColor = "#3acccb";
            if(caab.indexOf("25") == 0) //Echinoderms
                newCell.bgColor = "#c83314";
            if(caab.indexOf("23") == 0 || caab.indexOf("24") == 0) //Molluscs
                newCell.bgColor = "#ccc";
            if(caab.indexOf("10") == 0) //Sponges
                newCell.bgColor = "#cbc83d";
            if(caab.indexOf("20") == 0) //Bryozoa
                newCell.bgColor = "#0b1cf9";
            if(caab.indexOf("72") == 0 || caab.indexOf("70") == 0) //Bacterial mats
                newCell.bgColor = "#fcca6c";

            if(caab.indexOf("82001") == 0) //Substrate
                newCell.bgColor = "#daaeaa";
            if(caab.indexOf("82002") == 0) //Bedforms
                newCell.bgColor = "#c3fcba";
            if(caab.indexOf("82003") == 0) //Relief
                newCell.bgColor = "#cbfefb";

            if(caab.indexOf("80600903") == 0) //Jellies
                newCell.bgColor = "#2987c1";
            if(caab.indexOf("35100000") == 0) //Jellies
                newCell.bgColor = "#2987c1";
            if(caab.indexOf("35101000") == 0) //Jellies
                newCell.bgColor = "#2987c1";
            if(caab.indexOf("12000000") == 0) //Jellies
                newCell.bgColor = "#2987c1";
            if(caab.indexOf("11090000") == 0) //Jellies
                newCell.bgColor = "#2987c1";
            if(caab.indexOf("11120000") == 0) //Jellies
                newCell.bgColor = "#2987c1";
            if(caab.indexOf("11150000") == 0) //Jellies
                newCell.bgColor = "#2987c1";
            if(caab.indexOf("11000901") == 0) //Jellies
                newCell.bgColor = "#2987c1";

            if(caab.indexOf("80600901") == 0) //Worms
                newCell.bgColor = "#2fc553";
            if(caab.indexOf("22000000") == 0) //Worms
                newCell.bgColor = "#2fc553";
            if(caab.indexOf("17000000") == 0) //Worms
                newCell.bgColor = "#2fc553";
            if(caab.indexOf("17020000") == 0) //Worms
                newCell.bgColor = "#2fc553";
            if(caab.indexOf("13000000") == 0) //Worms
                newCell.bgColor = "#2fc553";
            if(caab.indexOf("36110000") == 0) //Worms
                newCell.bgColor = "#2fc553";
            if(caab.indexOf("15400000") == 0) //Worms
                newCell.bgColor = "#2fc553";
            if(caab.indexOf("22000901") == 0) //Worms
                newCell.bgColor = "#2fc553";
            if(caab.indexOf("22000902") == 0) //Worms
                newCell.bgColor = "#2fc553";

            //console.log(codeList[i].fields.cpc_code);

            // handle the cell clicks
            $(newCell).click(function (e) {

                var cell = e.target;

                annotationCode = annotationCodeList.find(function (model) {
                    return $(cell).text() === model.get('cpc_code');
                });

                var annotationType = parent.getSelectedAnnotationType();

                // fire off an event
                if(annotationType == 'broadScaleAnnotation')
                    GlobalEvent.trigger("broad_scale_annotation_to_be_set", annotationCode.get("caab_code"), annotationType);
                else
                    GlobalEvent.trigger("annotation_to_be_set", annotationCode.get("caab_code"), annotationType);
            });
        }
