...
DOLLY_SEARCH_URL = "http://localhost:8080/dolly/search"
WMS_URL = "http://localhost:8080/geoserver/wms" # standard config for local host
WFS_URL = "http://localhost:8080/geoserver/wfs"
LAYER_IMAGES = "benthobox:catamidb_images"
LAYER_DEPLOYMENTS = "benthobox:catamidb_deployment"
LAYER_CAMPAIGNS = "benthobox:catamidb_campaigns_centroid"
LAYER_PROJECTS = "benthobox:project_images"
LAYER_ANNOTATIONSET = "benthobox:annotationset_images"
THUMBNAILER_URL = 'http://localhost:8888/unsafe/136x102/'

ENVIRONCOMS_URL="http://144.6.226.206/ecoms/api/user_v1"
ENVIRONCOMS_IMAGE_DOWNLOAD_PREFIX='http://144.6.226.206/ecoms/api/user_v1/data/download'
ENVIRONCOMS_UNAME='tjeu0nvs7r0ck4sm2ndb18d316'
ENVIRONCOMS_PWD='70m3jrus8gbv56v14jkqv0nvd'
ENVIROCOMS_ORG_ID=8
ENVIROCOMS_COLLECTION_ID=1

ADMINS = (
    ('Mathew Wyatt', 'mathew.wyatt@gmail.com'),
)
...
IMAGES_URL = 'images'
IMPORT_PATH = '/home/benthobox/benthobox-data'
THUMBNAIL_SIZE = [136,102]

# Absolute filesystem path to the directory that will hold user-uploaded files.
# Example: "/home/media/media.lawrence.com/media/"
MEDIA_ROOT = '/home/benthobox/benthobox-data'
...
WSGI_APPLICATION = 'benthobox.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(SITE_ROOT, 'benthobox/templates')
)
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'formatter': 'simple',
            'filename': os.path.join(SITE_ROOT, 'log/benthobox.log')
        }
    },
    'loggers': {
        'root': {
